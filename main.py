...
# Create clustering options - EXACT SAME AS CONTENT TOPIC CLUSTERING
col1, col2 = st.columns(2)
...
with col2:
    ...
    min_shared_keywords = st.slider(
        ...
        min_value=2, 
        max_value=15, 
        value=3,  # Default 3 - SAME AS CONTENT TOPIC CLUSTERING
...
# Add clustering approach selection - IDENTICAL TO CONTENT TOPIC
...
if st.button("Generate Intent-Based Clusters", key="generate_intent_clusters"):
    ...
    with st.spinner("Analyzing keyword patterns with semantic intent-based clustering..."):
        ...
        # Handle Is_Outlier column safely - JUST LIKE CONTENT TOPIC
        ...
        **Clustering Summary:**
        ...
        # Get a_tags directly from cluster_info
        ...
        # Add quality indicator column - SAME AS CONTENT TOPIC
